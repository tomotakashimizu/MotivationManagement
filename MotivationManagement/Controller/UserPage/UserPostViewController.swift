...
class UserPostViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MotivationPostTableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "過去の記録"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if posts.count > 0 {
            ...
            noRecordCell.noRecordLabel.text = "記録はまだありません。"
            return noRecordCell
        }
    }
